...
def create_app():
    ...
    app.config['WEBAUTHN_RP_ID']    = 'localhost'   # or 'localhost' for dev | secora.app
    app.config['WEBAUTHN_ORIGIN']   = 'http://localhost:5000'  # or 'http://localhost:5000' | 'https://secora.app'
